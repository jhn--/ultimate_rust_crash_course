...
/*
[root@Gilgamesh b_functions]# cargo run
   Compiling b_functions v0.1.0 (/mnt/d/Users/User/Dropbox/work/courses/udemy/ultimate_rust_crash_course/_sandbox/exercise_b/b_functions)
    Finished dev [unoptimized + debuginfo] target(s) in 2.16s
     Running `target/debug/b_functions`
Area is 28
Volume is 280
*/

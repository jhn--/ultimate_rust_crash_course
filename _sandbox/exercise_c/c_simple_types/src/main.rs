...
/*
part 1
[root@Gilgamesh c_simple_types]# cargo run
   Compiling ding_machine v0.1.0 (...)
    Finished dev [unoptimized + debuginfo] target(s) in 2.74s
     Running `target/debug/ding_machine`
Difference between 6.3 and 15 is 8.7
*/
...
Ding, you found 13!
Lights are on!
Distance to the origin is 16.269297
*/